# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (22).ipynb`
...
| --- | --- |
| Review order | 23 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (22).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-22.md |
| SHA-256 | 1d39087b3b623d103c392ee3c430fa640cac09f92e62da296351047ee43a3dec |
| Size (bytes) | 42,739 |
| Modified (UTC) | 2026-04-18T19:42:47.043320+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (21).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (21).ipynb`, cell count changed from 5 to 5, stored output types changed from 8 to 10, and exact shared cell sources = 4.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني (Fixed Formatting & ID Sanitization) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني (Memory Safe Edition - Streaming) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني (Fixed Formatting & ID Sanitization) ---` |
...
- stream[stdout] with 3 line(s); excerpt: ⚡ حالة المسرع: cuda ⚙️ جاري تحميل المحرك البلاتيني... 🚀 بدء الاستخراج (Format Fixing Mode)...
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 24/24 [00:31<00:00,  1.33s/it]
- stream[stdout] with 1 line(s); excerpt: ✅ تم حفظ submission.csv بتنسيق سليم (Fixed IDs & Floats).
