# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (6).ipynb`
...
| --- | --- |
| Review order | 7 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (6).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-6.md |
| SHA-256 | 455e0ca8d0028f3fe822cc80796c524492fdc4fa9009088c938467679176db8f |
| Size (bytes) | 4,238,732 |
| Modified (UTC) | 2026-04-18T19:32:08.095007+00:00 |
...
- ⚠️ لم يتم العثور على موديل سابق، سيتم التدريب من الصفر (قد يأخذ وقتاً أطول).
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (5).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (5).ipynb`, cell count changed from 23 to 23, stored output types changed from 63 to 58, and exact shared cell sources = 21.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: `torch.load: best_model_phase2.pth`
- New first-line titles: `# --- الخلية 17: اختبار يدوي (مصحح) ---`, `# --- الخلية 22: محرك الاستخراج عالي الدقة (Phase 3: High-Fidelity Inference) ---`
- Removed first-line titles: `# --- الخلية 22: المصنع النهائي المطور (Phase 2 Quality Boost + Physics) ---`, `# خلية 17`
...
- Stored outputs include 5 warning-like lines worth checking during reruns.
...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 50/50 [00:12<00:00,  4.09it/s]
...
- stream[stdout] with 12 line(s); excerpt: 🚀 بدء التدريب على 50 صورة لمدة 10 دورات... Epoch [1/10] | Loss: 0.7908 Epoch [2/10] | Loss: 0.6965 Epoch [3/10] | Loss: 0.6367 Epoch [4/10] | Loss: 0.5849 Epoch [5/10] | Loss: 0.53...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-04-output-04.png; text excerpt: <Figure size 1200x400 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-04-output-04.png
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-06-output-01.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-06-output-01.png
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-07-output-02.png; text excerpt: <Figure size 1500x1200 with 8 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-07-output-02.png
...
- stream[stdout] with 6 line(s); excerpt: 📦 جاري تجهيز ملف التسليم لـ 3 عينات (باستخدام Viterbi)... ✅ تم إنشاء ملف التسليم بنجاح. معاينة البيانات: [     67.997      68.002      68.011      68.015      68.012      68.013   ...
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-10-output-02.png; text excerpt: <Figure size 1500x1200 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-10-output-02.png
...
- stream[stdout] with 4 line(s); excerpt: 🔍 جاري البحث عن صور في كل المجلدات... 🧪 تحليل الصورة: 170158778-0011.png 📂 المسار: /kaggle/input/physionet-ecg-image-digitization/train/170158778/170158778-0011.png 1️⃣ جاري حساب ح...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-12-output-02.png; text excerpt: <Figure size 1000x400 with 1 Axes>
- stream[stdout] with 3 line(s); excerpt: 📏 حجم المربع الصغير المقدر: 13.50 بكسل 2️⃣ استخراج الإشارة... 📏 حجم الشبكة المعدل (للمعايرة): 13.75 بكسل
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-12-output-04.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-12-output-02.png
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-12-output-04.png
...
- stream[stdout] with 7 line(s); excerpt: 🚀 تشغيل نظام Sliding Window على صورة حقيقية... 📄 الصورة: 4138876976-0009.png 1️⃣ حساب الشبكة... 2️⃣ بناء خريطة الاحتمالات الكاملة... 3️⃣ استخراج المسار (Viterbi)... - حجم الشبكة ال...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-13-output-02.png; text excerpt: <Figure size 1500x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-6/cell-13-output-02.png
...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 3/3 [01:21<00:00, 27.32s/it]
- stream[stdout] with 4 line(s); excerpt: 🎉 النتيجة النهائية (أرقام حقيقية): [2.047, 2.563, 2.156, 1.8, 1.934, 2.165, 2.091, 1.875, 1.851, 1.982, 2.009, 1.916, 1.885, 1.892, 1.708, 1.326, 1.061, 1.098, 1.185, 1.008, 0.669,...
- stream[stderr] with 1 line(s)
...
- stream[stderr] with 2 line(s); excerpt: Training Data: 100%|██████████| 200/200 [01:52<00:00,  1.78it/s] Validation Data: 100%|██████████| 50/50 [00:28<00:00,  1.78it/s]
...
- stream[stdout] with 177 line(s); excerpt: [KDownloading https://github.com/ultralytics/assets/releases/download/v8.3.0/yolov8n.pt to 'yolov8n.pt': 100% ━━━━━━━━━━━━ 6.2MB 103.6MB/s 0.1s 🚀 بدء تدريب YOLOv8n على بيانات تخطي...
...
- stream[stdout] with 3 line(s); excerpt: ✅ تم تحميل 977 ملف إشارة للتدريب. ⚠️ لم يتم العثور على موديل سابق، سيتم التدريب من الصفر (قد يأخذ وقتاً أطول). 🔥 بدء مرحلة Hardening (بيانات قبيحة + Learning Rate منخفض)...
- stream[stderr] with 1 line(s); excerpt: Phase 2 Epoch 1/5: 100%|██████████| 55/55 [18:53<00:00, 20.61s/it, loss=0.924]
- stream[stdout] with 2 line(s); excerpt: Epoch 1 -> Train: 0.9262 | Val: 0.9135 💎 تحسن في التعامل مع البيانات الصعبة! الحفظ في best_model_phase2.pth...
- stream[stderr] with 1 line(s); excerpt: Phase 2 Epoch 2/5: 100%|██████████| 55/55 [19:25<00:00, 21.19s/it, loss=0.901]
- stream[stdout] with 2 line(s); excerpt: Epoch 2 -> Train: 0.8959 | Val: 0.8645 💎 تحسن في التعامل مع البيانات الصعبة! الحفظ في best_model_phase2.pth...
- stream[stderr] with 1 line(s); excerpt: Phase 2 Epoch 3/5: 100%|██████████| 55/55 [19:32<00:00, 21.32s/it, loss=0.831]
- stream[stdout] with 2 line(s); excerpt: Epoch 3 -> Train: 0.8551 | Val: 0.8362 💎 تحسن في التعامل مع البيانات الصعبة! الحفظ في best_model_phase2.pth...
- stream[stderr] with 1 line(s); excerpt: Phase 2 Epoch 4/5: 100%|██████████| 55/55 [19:23<00:00, 21.16s/it, loss=0.786]
- stream[stdout] with 2 line(s); excerpt: Epoch 4 -> Train: 0.8011 | Val: 0.7831 💎 تحسن في التعامل مع البيانات الصعبة! الحفظ في best_model_phase2.pth...
- stream[stderr] with 1 line(s); excerpt: Phase 2 Epoch 5/5: 100%|██████████| 55/55 [19:21<00:00, 21.13s/it, loss=0.63]
- stream[stdout] with 3 line(s); excerpt: Epoch 5 -> Train: 0.7210 | Val: 0.7197 💎 تحسن في التعامل مع البيانات الصعبة! الحفظ في best_model_phase2.pth... ✅ انتهت المرحلة الثانية. الموديل الجديد جاهز: best_model_phase2.pth
...
| Cell type | code |
| Execution count | 22 |
| First non-empty line | `# --- الخلية 22: محرك الاستخراج عالي الدقة (Phase 3: High-Fidelity Inference) ---` |
...
- stream[stdout] with 5 line(s); excerpt: ⚙️ جاري تحميل ترسانة النماذج (High-Fidelity Engine)... ✅ YOLO: تم التحميل. 💎 تم اختيار موديل المرحلة الثانية (Hardened Model). ✅ U-Net: جاهز للاستخراج. 🚀 بدء الاستخراج (High-Fideli...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 24/24 [11:51<00:00, 29.66s/it]
