# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (39).ipynb`
...
| --- | --- |
| Review order | 40 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (39).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-39.md |
| SHA-256 | 1f7894cf2ceeece6cdb266dcdad58d222d079f5bb96f61491b9f118159cfc1a9 |
| Size (bytes) | 38,365 |
| Modified (UTC) | 2026-04-18T20:15:58.193172+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (38).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (38).ipynb`, cell count changed from 5 to 5, stored output types changed from 7 to 9, and exact shared cell sources = 4.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- Cell 22: V47 (V46 BALANCED + SAFE FS from test.csv) ---`
- Removed first-line titles: `# --- Cell 22: V46 BALANCED (Template Lengths + Light Sniper Gate + TTA) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: V47 (V46 BALANCED + SAFE FS from test.csv) ---` |
| Role summary | Definition cell that defines 10 function(s). |
...
- stream[stdout] with 11 line(s); excerpt: ⚡ Device: cuda 📦 Reading template ids... 🧠 Mapping patient lengths from template (SAFE)... ✅ Lengths mapped for 2 pids. ✅ fs_map loaded: 2 items 🗂️ Indexing images... ✅ Indexed ima...
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 75000/75000 [00:03<00:00, 22932.99it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ Done. Ready to Submit.
...
- stream[stdout] with 4 line(s); excerpt: 🔍 Validating submission.csv strictly... ✅ All checks passed. 📦 submission.csv size: 1.93 MB 🎉 Ready to Submit.
