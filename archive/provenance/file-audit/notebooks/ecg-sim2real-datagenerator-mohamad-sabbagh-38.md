# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (38).ipynb`
...
| --- | --- |
| Review order | 39 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (38).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-38.md |
| SHA-256 | c7bd6654b68f24ce2020a6c77c7015e213e5f95d5f354f27bb0c885a7048d3a8 |
| Size (bytes) | 36,456 |
| Modified (UTC) | 2026-04-18T20:15:42.989201+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (37).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (37).ipynb`, cell count changed from 5 to 5, stored output types changed from 9 to 7, and exact shared cell sources = 4.
- New imports: None
- Removed imports: `math`
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- Cell 22: V46 BALANCED (Template Lengths + Light Sniper Gate + TTA) ---`
- Removed first-line titles: `# ============================`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: V46 BALANCED (Template Lengths + Light Sniper Gate + TTA) ---` |
...
- stream[stdout] with 10 line(s); excerpt: ⚡ Device: cuda 📦 Reading template ids... 🧠 Mapping patient lengths from template (SAFE)... ✅ Lengths mapped for 2 pids. 🗂️ Indexing images... ✅ Indexed images: 8,795 ⚙️ Loading mod...
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 75000/75000 [00:03<00:00, 23343.00it/s]
