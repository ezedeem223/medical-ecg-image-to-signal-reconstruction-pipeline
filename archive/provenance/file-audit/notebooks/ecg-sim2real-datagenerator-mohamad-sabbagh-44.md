# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (44).ipynb`
...
| --- | --- |
| Review order | 45 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (44).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-44.md |
| SHA-256 | 27c158e36ef8f6eb37c971b635d384d026a8f42ed9666359e585f39334cd19b1 |
| Size (bytes) | 39,304 |
| Modified (UTC) | 2026-04-18T20:17:13.698903+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (43).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (43).ipynb`, cell count changed from 5 to 5, stored output types changed from 11 to 14, and exact shared cell sources = 4.
- New imports: `re`
- Removed imports: None
- New model refs: None
- Removed model refs: `os.path.exists: /kaggle/input/ecg-final-models1/best_model_deeplab_ph10.pth`, `os.path.exists: /kaggle/input/ecg-final-models1/best_model_efficientnet_ph10.pth`, `torch.load: /kaggle/input/ecg-final-models1/best_model_deeplab_ph10.pth`, `torch.load: /kaggle/input/ecg-final-models1/best_model_efficientnet_ph10.pth`
- New first-line titles: `# --- Cell 22: V41 Baseline Check (ResNet50 Only + Robust Paths) ---`
- Removed first-line titles: `# --- Cell 22: V39 Ultimate (Ensemble: ResNet + EffNet + DeepLab) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: V41 Baseline Check (ResNet50 Only + Robust Paths) ---` |
...
- stream[stderr] with 1 line(s); excerpt: Scanning Lengths: 100%|██████████| 75000/75000 [00:00<00:00, 619617.13it/s]
...
- stream[stdout] with 9 line(s); excerpt: ✅ Indexed images: 8,795 (Unique numeric IDs) ✅ fs_map loaded: 2 items ⚙️ Loading models (SINGLE MODEL MODE)... ✅ YOLO loaded. 🔹 Loading ONLY ResNet50 from: best_model_phase10.pth ✅...
- stream[stderr] with 1 line(s); excerpt: Processing:  35%|███▍      | 26089/75000 [00:01<00:02, 18448.24it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ Processed 1053922973: Found signal!
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 75000/75000 [00:02<00:00, 30902.59it/s]
