# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (25).ipynb`
...
| --- | --- |
| Review order | 26 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (25).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-25.md |
| SHA-256 | 2e920a298c157bb33bb2a2ec282fbc8a22d7f6ad33c01db540e565c984ca27dd |
| Size (bytes) | 39,735 |
| Modified (UTC) | 2026-04-18T19:43:24.801355+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (24).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (24).ipynb`, cell count changed from 5 to 5, stored output types changed from 8 to 10, and exact shared cell sources = 3.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني النهائي (Version 26: Robust & Scoring Safe) ---`, `# --- الخلية 23: التحقق الآمن (Final Logic Check) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني (Fixing Scoring Error: Robust ID) ---`, `# --- الخلية 23: التحقق النهائي الآمن ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني النهائي (Version 26: Robust & Scoring Safe) ---` |
...
- stream[stdout] with 4 line(s); excerpt: ⚡ النظام يعمل على: cuda ⚙️ جاري تحميل الموديلات... 🚀 بدء المعالجة (Version 26)... 📊 عدد العينات: 2
- stream[stderr] with 1 line(s); excerpt: Inference: 100%|██████████| 2/2 [00:04<00:00,  2.17s/it]
- stream[stdout] with 1 line(s); excerpt: ✅ تم الانتهاء. الملف جاهز ومطابق للمواصفات 100%.
