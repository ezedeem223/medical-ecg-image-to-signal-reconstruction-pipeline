# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (32).ipynb`
...
| --- | --- |
| Review order | 33 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (32).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-32.md |
| SHA-256 | e3303fe3c05548340e819d4e2737eef59a89635dad34e4e48a0aa9d14c09ad32 |
| Size (bytes) | 43,357 |
| Modified (UTC) | 2026-04-18T20:13:19.669684+00:00 |
...
- glob.glob: /kaggle/input/physionet-ecg-image-digitization/**/*.jpeg
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (31).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (31).ipynb`, cell count changed from 5 to 5, stored output types changed from 3 to 7, and exact shared cell sources = 3.
- New imports: `math`, `pyarrow`
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- Cell 22: Merged Ultra Safe Engine (Parquet + Streaming + Anti-OOM + Anti-Crash) ---`, `# --- Cell 2: Offline install/import fix (NO internet) ---`
- Removed first-line titles: None
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: Merged Ultra Safe Engine (Parquet + Streaming + Anti-OOM + Anti-Crash) ---` |
| Role summary | Definition cell that defines 14 function(s). |
...
- stream[stdout] with 10 line(s); excerpt: ⚡ Device: cuda 📦 Reading Parquet template ids... ✅ Template rows: 75,000 ✅ fs_map loaded: 2 items 🗂️ Indexing images... ✅ Indexed images: 8,795 ⚙️ Loading models (offline)... ✅ YOL...
- stream[stderr] with 1 line(s); excerpt: Processing Rows: 100%|██████████| 75000/75000 [00:03<00:00, 24668.57it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ Done. submission.csv created successfully.
