# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (52).ipynb`
...
| --- | --- |
| Review order | 53 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (52).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-52.md |
| SHA-256 | 5b345b9859b809c22d9142e2915e4cd28eb1161d6fd6e9228e97b95face932bd |
| Size (bytes) | 48,521 |
| Modified (UTC) | 2026-04-18T21:16:31.709960+00:00 |
...
- /kaggle/input/physionet-ecg-image-digitization/p
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (51).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (51).ipynb`, cell count changed from 6 to 6, stored output types changed from 14 to 10, and exact shared cell sources = 4.
- New imports: None
- Removed imports: `math`
- New model refs: `YOLO: /kaggle/input/ecg-final-models1/best.pt`, `os.path.exists: /kaggle/input/ecg-final-models1/best.pt`, `os.path.exists: /kaggle/input/ecg-final-models1/best_model_phase10.pth`
- Removed model refs: None
- New first-line titles: `# --- Cell 1: Smart Offline Install (SAFE & MINIMAL) ---`, `# --- Cell 22: V40 FINAL (test.csv path map + ImageNet norm + NEW/OLD ensemble + robust DP) ---`
- Removed first-line titles: `# --- Cell 22: V39+++ Ultimate (Robust ID Parser + NEW EffB3 UNet + Safe Calibration + Optional OLD fallback) ---`, `# --- الخلية 1: التثبيت الذكي (Smart Offline Install) ---`
...
| Cell type | code |
| Execution count | 5 |
| First non-empty line | `# --- Cell 22: V40 FINAL (test.csv path map + ImageNet norm + NEW/OLD ensemble + robust DP) ---` |
| Role summary | Definition cell that defines 22 function(s). |
...
- nw = 2048
- p2 = /kaggle/input/physionet-ecg-image-digitization/p
- path = path2
- path_c = low[k]
- preds = p_new
- prev = dp[idx]
...
- stream[stdout] with 11 line(s); excerpt: ⚡ Device: cuda 📌 Paths exist: | NEW: True | OLD: True | YOLO: True ✅ Template rows: 75000 ✅ patient_lengths mapped: 2 | bad_parse: 0 ✅ test.csv columns: ['id', 'lead', 'fs', 'numbe...
- stream[stderr] with 1 line(s); excerpt: Processing Rows: 100%|██████████| 75000/75000 [00:15<00:00, 4727.88it/s]
