# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (3).ipynb`
...
| --- | --- |
| Review order | 4 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (3).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-3.md |
| SHA-256 | 73b1867cba9fa2f675a1407a73acfbe8e7ed832777362767d19f653634a818a6 |
| Size (bytes) | 3,653,690 |
| Modified (UTC) | 2026-04-18T19:31:20.520745+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (2).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (2).ipynb`, cell count changed from 23 to 22, stored output types changed from 67 to 66, and exact shared cell sources = 16.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# خلية 23`
- Removed first-line titles: `!pip install ultralytics`, `# خلية 18`
...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 50/50 [00:13<00:00,  3.66it/s]
...
- stream[stdout] with 12 line(s); excerpt: 🚀 بدء التدريب على 50 صورة لمدة 10 دورات... Epoch [1/10] | Loss: 0.7612 Epoch [2/10] | Loss: 0.6048 Epoch [3/10] | Loss: 0.5241 Epoch [4/10] | Loss: 0.4632 Epoch [5/10] | Loss: 0.40...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-04-output-04.png; text excerpt: <Figure size 1200x400 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-04-output-04.png
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-06-output-01.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-06-output-01.png
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-07-output-02.png; text excerpt: <Figure size 1500x1200 with 8 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-07-output-02.png
...
- stream[stdout] with 6 line(s); excerpt: 📦 جاري تجهيز ملف التسليم لـ 3 عينات (باستخدام Viterbi)... ✅ تم إنشاء ملف التسليم بنجاح. معاينة البيانات: [     255.28       255.5      255.72      255.73      255.58      255.47   ...
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-10-output-02.png; text excerpt: <Figure size 1500x1200 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-10-output-02.png
...
- stream[stdout] with 4 line(s); excerpt: 🔍 جاري البحث عن صور في كل المجلدات... 🧪 تحليل الصورة: 3554875690-0003.png 📂 المسار: /kaggle/input/physionet-ecg-image-digitization/train/3554875690/3554875690-0003.png 1️⃣ جاري حسا...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-12-output-02.png; text excerpt: <Figure size 1000x400 with 1 Axes>
- stream[stdout] with 3 line(s); excerpt: 📏 حجم المربع الصغير المقدر: 13.50 بكسل 2️⃣ استخراج الإشارة... 📏 حجم الشبكة المعدل (للمعايرة): 14.00 بكسل
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-12-output-04.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-12-output-02.png
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-12-output-04.png
...
- stream[stdout] with 7 line(s); excerpt: 🚀 تشغيل نظام Sliding Window على صورة حقيقية... 📄 الصورة: 1135737846-0004.png 1️⃣ حساب الشبكة... 2️⃣ بناء خريطة الاحتمالات الكاملة... 3️⃣ استخراج المسار (Viterbi)... - حجم الشبكة ال...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-13-output-02.png; text excerpt: <Figure size 1500x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-3/cell-13-output-02.png
...
- stream[stdout] with 1 line(s); excerpt: 📐 تم اكتشاف ميل وتصحيحه بزاوية: -1.35 درجة
- stream[stderr] with 1 line(s); excerpt: 33%|███▎      | 1/3 [00:21<00:42, 21.46s/it]
- stream[stdout] with 1 line(s); excerpt: 📐 تم اكتشاف ميل وتصحيحه بزاوية: -89.85 درجة
- stream[stderr] with 1 line(s); excerpt: 67%|██████▋   | 2/3 [00:42<00:21, 21.25s/it]
- stream[stdout] with 1 line(s); excerpt: 📐 تم اكتشاف ميل وتصحيحه بزاوية: -90.00 درجة
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 3/3 [01:05<00:00, 21.99s/it]
- stream[stdout] with 4 line(s); excerpt: 🎉 النتيجة النهائية (أرقام حقيقية): [-0.024, -0.032, -0.031, -0.025, -0.024, -0.028, -0.028, -0.022, -0.019, -0.023, -0.027, -0.026, -0.027, -0.028, -0.024, -0.017, -0.026, -0.053, ...
- stream[stderr] with 1 line(s)
...
- stream[stderr] with 2 line(s); excerpt: Training Data: 100%|██████████| 200/200 [02:01<00:00,  1.65it/s] Validation Data: 100%|██████████| 50/50 [00:29<00:00,  1.67it/s]
...
- stream[stdout] with 160 line(s); excerpt: [KDownloading https://github.com/ultralytics/assets/releases/download/v8.3.0/yolov8n.pt to 'yolov8n.pt': 100% ━━━━━━━━━━━━ 6.2MB 129.3MB/s 0.0s 🚀 بدء تدريب YOLOv8n على بيانات تخطي...
...
- stream[stdout] with 17 line(s); excerpt: all         50        600      0.998          1      0.995      0.995 I         50         50      0.998          1      0.995      0.995 II         50         50      0.998       ...
...
- stream[stderr] with 2 line(s); excerpt: /tmp/ipykernel_47/196857735.py:29: UserWarning: Argument(s) 'var_limit' are not valid for transform GaussNoise A.GaussNoise(var_limit=(20.0, 100.0), p=0.3),
- stream[stdout] with 1 line(s); excerpt: 🚀 بدء التدريب (Phase 1 Update)...
- stream[stderr] with 1 line(s); excerpt: Epoch 1/5: 100%|██████████| 49/49 [16:32<00:00, 20.25s/it, loss=0.832]
- stream[stdout] with 1 line(s); excerpt: Epoch 1 -> Train Loss: 0.8883 | Val Loss: 0.8286
- stream[stderr] with 1 line(s); excerpt: Epoch 2/5: 100%|██████████| 49/49 [16:28<00:00, 20.18s/it, loss=0.638]
- stream[stdout] with 1 line(s); excerpt: Epoch 2 -> Train Loss: 0.7374 | Val Loss: 0.6470
- stream[stderr] with 1 line(s); excerpt: Epoch 3/5: 100%|██████████| 49/49 [16:36<00:00, 20.34s/it, loss=0.351]
- stream[stdout] with 1 line(s); excerpt: Epoch 3 -> Train Loss: 0.4553 | Val Loss: 0.3999
- stream[stderr] with 1 line(s); excerpt: Epoch 4/5: 100%|██████████| 49/49 [16:40<00:00, 20.42s/it, loss=0.175]
- stream[stdout] with 1 line(s); excerpt: Epoch 4 -> Train Loss: 0.2192 | Val Loss: 0.1736
- stream[stderr] with 1 line(s); excerpt: Epoch 5/5: 100%|██████████| 49/49 [16:42<00:00, 20.46s/it, loss=0.0967]
- stream[stdout] with 2 line(s); excerpt: Epoch 5 -> Train Loss: 0.1291 | Val Loss: 0.1013 ✅ تم حفظ الموديل المحدث بنجاح!
...
- stream[stdout] with 4 line(s); excerpt: ⚙️ جاري تحميل ترسانة النماذج... ✅ YOLO: تم التحميل (جاهز للتقطيع الذكي). ✅ U-Net (Real Data): تم التحميل (جاهز للاستخراج الدقيق). 🚀 بدء المصنع النهائي (Fully Integrated)...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 24/24 [11:04<00:00, 27.70s/it]
- stream[stdout] with 2 line(s); excerpt: 💾 حفظ النتائج... ✅ تم حفظ submission.parquet (جاهز للتسليم!)
