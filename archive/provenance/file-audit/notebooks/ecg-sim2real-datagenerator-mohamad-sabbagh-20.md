# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (20).ipynb`
...
| --- | --- |
| Review order | 21 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (20).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-20.md |
| SHA-256 | b3c45fcceb739b51a5ade2e8e4ea872e0cb95bf4c4d7203cf879eacc49486cd1 |
| Size (bytes) | 44,008 |
| Modified (UTC) | 2026-04-18T19:42:20.311668+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (19).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (19).ipynb`, cell count changed from 5 to 5, stored output types changed from 3 to 9, and exact shared cell sources = 3.
- New imports: `gc`, `importlib`, `site`, `timm`
- Removed imports: None
- New model refs: `YOLO: yolov8n.pt`
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني المسرّع (GPU Batch Edition) - [CORRECTED] ---`, `# --- الخلية 2: الاستيراد والإصلاح الفوري (Import & Fix) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني المسرّع (GPU Batch Edition) ---`, `# --- الخلية 2: استيراد المكتبات وتجهيز البيئة ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني المسرّع (GPU Batch Edition) - [CORRECTED] ---` |
...
- stream[stdout] with 5 line(s); excerpt: ⚡ حالة المسرع: cuda (يجب أن يكون cuda لضمان السرعة) ⚙️ جاري تحميل المحرك البلاتيني (GPU Edition)... ✅ YOLO: تم التحميل. 💎 U-Net: تم التحميل. 🚀 بدء الاستخراج البلاتيني السريع (GPU B...
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 24/24 [00:28<00:00,  1.20s/it]
