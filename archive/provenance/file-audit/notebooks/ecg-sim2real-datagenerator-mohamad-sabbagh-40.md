# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (40).ipynb`
...
| --- | --- |
| Review order | 41 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (40).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-40.md |
| SHA-256 | 8a3dc643a7074aad8c0b8718d68ea0f84e2d7dfef5104c13aa8246ef4c94d9e5 |
| Size (bytes) | 50,597 |
| Modified (UTC) | 2026-04-18T20:16:17.007825+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (39).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (39).ipynb`, cell count changed from 5 to 5, stored output types changed from 9 to 9, and exact shared cell sources = 3.
- New imports: `math`
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- Cell 22: V40 Ultimate (Per-Lead Length from test.csv + Safe Mode + 0.5mm Grid + Confidence Gate + Linear-Phase Resample) ---`
- Removed first-line titles: `# --- Cell 22: V47 (V46 BALANCED + SAFE FS from test.csv) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: V40 Ultimate (Per-Lead Length from test.csv + Safe Mode + 0.5mm Grid + Confidence Gate + Linear-Phase Resample) ---` |
| Role summary | Definition cell that defines 19 function(s). |
...
- img_inf = img_rgb
- items = []
- lead_dict = patient_cache[pid]
- lead_idx = lead_indices[j]
- lead_name = I[lead_indices[j]]
...
- stream[stdout] with 14 line(s); excerpt: ⚡ Device: cuda 📦 Reading Parquet template ids... ✅ Template rows: 75,000 🧠 Reading test.csv (per-lead lengths + fs)... ✅ len_map entries: 24 ✅ unique patients in test.csv: 2 🔎 Exam...
- stream[stderr] with 1 line(s); excerpt: Processing Rows: 100%|██████████| 75000/75000 [00:03<00:00, 19210.54it/s]
