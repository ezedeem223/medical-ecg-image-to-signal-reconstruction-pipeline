# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (18).ipynb`
...
| --- | --- |
| Review order | 19 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (18).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-18.md |
| SHA-256 | 2edf66ff2abb6dd1f1cc9fab9039fe574196d0e672b4f1ed61f8c291b75d4ae7 |
| Size (bytes) | 40,536 |
| Modified (UTC) | 2026-04-18T19:41:51.694427+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (17).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (17).ipynb`, cell count changed from 5 to 5, stored output types changed from 8 to 8, and exact shared cell sources = 5.
- New imports: None
...
- stream[stdout] with 2 line(s); excerpt: ✅ نجاح! تم استيراد (SMP) و (YOLO) بنجاح. 🚀 العمليات ستتم باستخدام: cuda
...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 24/24 [04:39<00:00, 11.66s/it]
