# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (33).ipynb`
...
| --- | --- |
| Review order | 34 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (33).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-33.md |
| SHA-256 | 7149e30da6b10ddcdc9017fc82aa861e41a74c1e1b80098340b4d8b7a61a6d57 |
| Size (bytes) | 47,288 |
| Modified (UTC) | 2026-04-18T20:13:36.929495+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (32).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (32).ipynb`, cell count changed from 5 to 5, stored output types changed from 7 to 13, and exact shared cell sources = 4.
- New imports: None
- Removed imports: `math`
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني النهائي (V36: Dynamic Length + Safe Mode + Original Calibration) ---`
- Removed first-line titles: `# --- Cell 22: Merged Ultra Safe Engine (Parquet + Streaming + Anti-OOM + Anti-Crash) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني النهائي (V36: Dynamic Length + Safe Mode + Original Calibration) ---` |
...
- fs_val = 500.0
- grid_sizes = []
- leads_mtx = patient_cache[pid[idx]]
- lname = I[real_idx]
- max_w = 3000
- new_w = 2048
- pid = pid[idx]
...
- stream[stdout] with 4 line(s); excerpt: ⚡ Device: cuda 📦 Reading Parquet template ids... ✅ Template rows: 75,000 🧠 Scanning template for dynamic lengths per patient...
- stream[stderr] with 1 line(s); excerpt: Scan Lengths: 100%|██████████| 75000/75000 [00:00<00:00, 909114.76it/s]
- stream[stdout] with 3 line(s); excerpt: ✅ Dynamic lengths computed for 2 patients. ✅ fs_map loaded: 2 items 🗂️ Indexing images...
- stream[stderr] with 1 line(s)
- stream[stdout] with 5 line(s); excerpt: ✅ Indexed images: 8,795 ⚙️ Loading models (offline)... ✅ YOLO loaded: /kaggle/input/ecg-final-models/best.pt ✅ UNet loaded: /kaggle/input/ecg-final-models/best_model_phase10.pth 🚀 ...
- stream[stderr] with 1 line(s); excerpt: Processing Rows: 100%|██████████| 75000/75000 [00:03<00:00, 21356.43it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ Done. submission.csv created with correct template rows + dynamic per-patient length.
...
- stream[stdout] with 4 line(s); excerpt: 🔍 Validating submission.csv strictly... ✅ All checks passed. 📦 submission.csv size: 1.97 MB 🎉 Ready to Submit.
