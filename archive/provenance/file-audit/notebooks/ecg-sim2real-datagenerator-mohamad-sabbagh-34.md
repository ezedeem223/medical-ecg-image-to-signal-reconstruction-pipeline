# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (34).ipynb`
...
| --- | --- |
| Review order | 35 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (34).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-34.md |
| SHA-256 | 34d8469c93121a1110468cb268d355ae0f1b53341502b773e923379fbeb5d4b2 |
| Size (bytes) | 51,246 |
| Modified (UTC) | 2026-04-18T20:13:57.416360+00:00 |
...
- Processing Rows:   0%|          | 0/75000 [00:00<?, ?it/s]/tmp/ipykernel_19/1948205079.py:480: FutureWarning: `torch.cuda.amp.autocast(args...)` is deprecated. Please use `torch.amp.autocast('cuda', args...)` instead.
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (33).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (33).ipynb`, cell count changed from 5 to 5, stored output types changed from 13 to 13, and exact shared cell sources = 4.
- New imports: `math`
...
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني النهائي (V36: Dynamic Length + Safe Mode + Original Calibration) ---`
...
- Stored outputs include 15 warning-like lines worth checking during reruns.
...
- stream[stderr] with 1 line(s); excerpt: Scanning Lengths: 100%|██████████| 75000/75000 [00:00<00:00, 919698.63it/s]
- stream[stdout] with 2 line(s); excerpt: ✅ Lengths mapped for 2 patients. 🗂️ Indexing images...
- stream[stderr] with 1 line(s)
- stream[stdout] with 7 line(s); excerpt: ✅ Indexed images: 8,795 ✅ fs_map loaded: 2 items ⚙️ Loading models (offline)... ✅ YOLO loaded: /kaggle/input/ecg-final-models/best.pt ✅ CLASS_TO_LEAD_IDX: {0: 0, 1: 1, 2: 2, 3: 3, ...
- stream[stderr] with 3 line(s); excerpt: Processing Rows:   0%|          | 0/75000 [00:00<?, ?it/s]/tmp/ipykernel_19/1948205079.py:480: FutureWarning: `torch.cuda.amp.autocast(args...)` is deprecated. Please use `torch.am...
