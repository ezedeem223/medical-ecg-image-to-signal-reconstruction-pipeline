# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (30).ipynb`
...
| --- | --- |
| Review order | 31 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (30).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-30.md |
| SHA-256 | 7dd1ace62d3c007528730bb47fb2b37b7b8658e653bb4bd0e1d46177625d78f3 |
| Size (bytes) | 38,690 |
| Modified (UTC) | 2026-04-18T20:12:51.697710+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (29).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (29).ipynb`, cell count changed from 5 to 5, stored output types changed from 10 to 8, and exact shared cell sources = 4.
- New imports: `math`
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني (Version 32: Literal ID Match & Robust Length) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني (Version 31: Read-Only System Fix) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني (Version 32: Literal ID Match & Robust Length) ---` |
...
- stream[stdout] with 4 line(s); excerpt: ⚡ النظام يعمل على: cuda ⚙️ جاري تحميل الموديلات... 🚀 بدء الاستخراج (Version 32: Literal IDs & Dynamic Length)... 📊 عدد الصفوف: 24
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 24/24 [00:35<00:00,  1.46s/it]
- stream[stdout] with 1 line(s); excerpt: ✅ تم الانتهاء (Literal ID Match + Robust Length).
