# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (46).ipynb`
...
| --- | --- |
| Review order | 47 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (46).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-46.md |
| SHA-256 | 7c80ead9c1294ff5576930542fd1316f9b265eb7bb9fb0739f6e2b9e4502ea15 |
| Size (bytes) | 41,218 |
| Modified (UTC) | 2026-04-18T20:39:28.177415+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (45).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (45).ipynb`, cell count changed from 5 to 5, stored output types changed from 11 to 14, and exact shared cell sources = 4.
- New imports: `re`
...
- Removed model refs: `YOLO: /kaggle/input/ecg-final-models/best.pt`, `os.path.exists: /kaggle/input/ecg-final-models/best.pt`, `os.path.exists: /kaggle/input/ecg-final-models/best_model_phase10.pth`, `torch.load: /kaggle/input/ecg-final-models/best_model_phase10.pth`
- New first-line titles: `# --- Cell 22: V43 Hybrid (Ensemble + Robust Paths + Fixed Calibration) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- Cell 22: V43 Hybrid (Ensemble + Robust Paths + Fixed Calibration) ---` |
...
- model_files = ['/kaggle/input/ecg-final-models1/best_model_phase10.pth', '/kaggle/input/ecg-final-models1/best_model_efficientnet_ph10.pth', '/kaggle/input/ecg-final-models1/best_model_deeplab_ph10.pth']
...
- stream[stdout] with 5 line(s); excerpt: ⚡ Device: cuda 🔒 Scaling Strategy: Fixed at 250.0 (No auto-calibration) 📦 Reading Parquet template ids... ✅ Template rows: 75,000 🧠 Scanning template for patient lengths...
- stream[stderr] with 1 line(s); excerpt: Scanning Lengths: 100%|██████████| 75000/75000 [00:00<00:00, 638870.49it/s]
- stream[stdout] with 11 line(s); excerpt: ✅ Lengths mapped for 2 patients. 🗂️ Indexing images (Robust Mode)... ✅ Indexed images: 8,795 (Unique numeric IDs) ✅ fs_map loaded: 2 items ⚙️ Loading models (FULL ENSEMBLE MODE)......
- stream[stderr] with 1 line(s); excerpt: Processing:  37%|███▋      | 27900/75000 [00:07<00:09, 5098.18it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ Processed 1053922973: Signal Found & Scaled Safely!
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 75000/75000 [00:13<00:00, 5514.45it/s]
- stream[stdout] with 2 line(s); excerpt: ✅ Processed 2352854581: Signal Found & Scaled Safely! ✅ Submission file generated successfully.
