# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (2).ipynb`
...
| --- | --- |
| Review order | 3 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (2).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-2.md |
| SHA-256 | 325f96d574470f54c5f11d736881f31fd83e46f532244ce2cf3ab97bec6db945 |
| Size (bytes) | 3,760,362 |
| Modified (UTC) | 2026-04-18T19:31:01.223466+00:00 |
...
- ⚠️ تحذير: الشبكة غير واضحة، سيتم استخدام قيمة افتراضية.
- /usr/local/lib/python3.11/dist-packages/matplotlib/colors.py:721: RuntimeWarning: invalid value encountered in less
- /tmp/ipykernel_570/3213250916.py:30: UserWarning: Argument(s) 'quality_lower' are not valid for transform ImageCompression
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (1).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (1).ipynb`, cell count changed from 8 to 23, stored output types changed from 13 to 67, and exact shared cell sources = 1.
- New imports: `shutil`, `skimage.io`, `skimage.morphology`, `ultralytics`
- Removed imports: None
- New model refs: `YOLO: runs/detect/ecg_layout_detector/weights/best.pt`, `YOLO: yolov8n.pt`, `os.path.exists: best_model_real_data.pth`, `os.path.exists: runs/detect/ecg_layout_detector/weights/best.pt`, `torch.load: best_model_real_data.pth`, `torch.save: best_model.pth`, `torch.save: best_model_real_data.pth`
- Removed model refs: None
- New first-line titles: `!pip install ultralytics`, `# --- الخلية 6---`, `# --- الخلية 7 ---`, `# --- الخلية 8:  ---`, `# --- الخلية 9:  ---`, `# --الخلية 5 ---`, `# الخلية 10`, `# الخلية 11`, `# خلية 12`, `# خلية 13`, `# خلية 14`, `# خلية 15`, `# خلية 16`, `# خلية 17`, `# خلية 18`, `# خلية 19`, `# خلية 2`, `# خلية 20`, `# خلية 21`, `# خلية 22`, `# خلية 3`, `# خلية 4`
- Removed first-line titles: `# --- Cell 2: Global Imports & Device Config ---`, `# --- الخلية 3: مولد البيانات وتدريب الموديل ---`, `# --- الخلية 4: التدريب ورسم النتائج ---`, `# --- الخلية 5: خوارزميات المعالجة واختبارها بصرياً ---`, `# --- الخلية 6: المعايرة واكتشاف الشبكة (مع الرسم) ---`, `# --- الخلية 7: اختبار على صور واقعية (مع الرسم) ---`, `# --- الخلية 8: الحفظ النهائي ---`
...
- Stored outputs include 7 warning-like lines worth checking during reruns.
...
- stream[stdout] with 83 line(s); excerpt: Requirement already satisfied: numpy<2 in /usr/local/lib/python3.11/dist-packages (1.26.4) Requirement already satisfied: matplotlib in /usr/local/lib/python3.11/dist-packages (3.7...
...
- stream[stdout] with 3 line(s); excerpt: ⏳ جاري تثبيت المكتبات الكاملة... سيتم إعادة التشغيل تلقائياً. ✅ تم تجهيز المعمل بالكامل (Data, AI, CSV, Processing). 🚀 الجهاز الجاهز للعمل: cuda
...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 50/50 [00:09<00:00,  5.34it/s]
...
- stream[stdout] with 12 line(s); excerpt: 🚀 بدء التدريب على 100 صورة لمدة 10 دورات... Epoch [1/10] | Loss: 0.7670 Epoch [2/10] | Loss: 0.6655 Epoch [3/10] | Loss: 0.5917 Epoch [4/10] | Loss: 0.5192 Epoch [5/10] | Loss: 0.4...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-04-output-02.png; text excerpt: <Figure size 1200x400 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-04-output-02.png

**Output interpretation**

- Output 2: Three-panel training sanity check titled Input / Target / AI Prediction. The left panel is a synthetic Lead II strip on red ECG paper, the middle panel is a binary mask, and the right panel is the predicted mask. Peak timing is preserved well, but small baseline details and trace thickness still drift between the target and the prediction.
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-06-output-01.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-06-output-01.png
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-07-output-02.png; text excerpt: <Figure size 1500x1200 with 8 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-07-output-02.png
...
- stream[stdout] with 8 line(s); excerpt: 📦 جاري تجهيز ملف التسليم لـ 3 عينات (باستخدام Viterbi)... ✅ تم إنشاء ملف التسليم بنجاح. معاينة البيانات: [68.     68.0106 67.9992 67.9895 68.0017 68.0106 67.9975 67.9893 68.0028 68...
...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-10-output-02.png; text excerpt: <Figure size 1500x1200 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-10-output-02.png
...
- stream[stdout] with 4 line(s); excerpt: 🔍 جاري البحث عن صور في كل المجلدات... 🧪 تحليل الصورة: 548033375-0009.png 📂 المسار: /kaggle/input/physionet-ecg-image-digitization/train/548033375/548033375-0009.png 1️⃣ جاري حساب ح...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-12-output-02.png; text excerpt: <Figure size 1000x400 with 1 Axes>
- stream[stdout] with 3 line(s); excerpt: 📏 حجم المربع الصغير المقدر: 12.00 بكسل 2️⃣ استخراج الإشارة... 📏 حجم الشبكة المعدل (للمعايرة): 15.25 بكسل
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-12-output-04.png; text excerpt: <Figure size 1200x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-12-output-02.png
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-12-output-04.png
...
- stream[stdout] with 7 line(s); excerpt: 🚀 تشغيل نظام Sliding Window على صورة حقيقية... 📄 الصورة: 831376508-0001.png 1️⃣ حساب الشبكة... 2️⃣ بناء خريطة الاحتمالات الكاملة... 3️⃣ استخراج المسار (Viterbi)... - حجم الشبكة الأ...
- display_data MIME=image/png, text/plain; image payload present; artifact=image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-13-output-02.png; text excerpt: <Figure size 1500x800 with 3 Axes>
...
- image-outputs/ecg-sim2real-datagenerator-mohamad-sabbagh-2/cell-13-output-02.png
...
- stream[stdout] with 1 line(s); excerpt: 📐 تم اكتشاف ميل وتصحيحه بزاوية: -89.98 درجة
- stream[stderr] with 1 line(s); excerpt: 33%|███▎      | 1/3 [00:13<00:27, 13.88s/it]
- stream[stdout] with 1 line(s); excerpt: ⚠️ تحذير: الشبكة غير واضحة، سيتم استخدام قيمة افتراضية.
- stream[stderr] with 1 line(s); excerpt: 67%|██████▋   | 2/3 [00:26<00:13, 13.14s/it]
- stream[stdout] with 1 line(s); excerpt: 📐 تم اكتشاف ميل وتصحيحه بزاوية: -90.00 درجة
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 3/3 [00:35<00:00, 11.69s/it]
- stream[stdout] with 4 line(s); excerpt: 🎉 النتيجة النهائية (أرقام حقيقية): [0.695, 0.687, 0.693, 0.703, 0.701, 0.692, 0.692, 0.7, 0.701, 0.693, 0.688, 0.694, 0.7, 0.695, 0.687, 0.688, 0.696, 0.696, 0.689, 0.687, 0.694, 0...
- stream[stderr] with 1 line(s)
...
- stream[stdout] with 4 line(s); excerpt: ⚙️ جاري تحميل النماذج الذكية... ✅ YOLO: تم التحميل (جاهز للتقطيع الذكي). ✅ U-Net (Real Data): تم التحميل (جاهز للاستخراج الدقيق). 🚀 بدء المصنع النهائي (YOLO + Real Data U-Net)...
- stream[stderr] with 1 line(s); excerpt: 100%|██████████| 24/24 [05:55<00:00, 14.82s/it]
- stream[stdout] with 2 line(s); excerpt: 💾 حفظ النتائج النهائية... ✅ تم حفظ submission.parquet (النسخة النهائية الكاملة!)
...
- stream[stderr] with 2 line(s); excerpt: Training Data: 100%|██████████| 200/200 [01:26<00:00,  2.32it/s] Validation Data: 100%|██████████| 50/50 [00:21<00:00,  2.31it/s]
...
| Cell type | code |
| Execution count | 22 |
| First non-empty line | `!pip install ultralytics` |
| Role summary | Environment bootstrap cell with package installation commands. |
...
- stream[stdout] with 66 line(s); excerpt: Collecting ultralytics Downloading ultralytics-8.3.240-py3-none-any.whl.metadata (37 kB) Requirement already satisfied: numpy>=1.23.0 in /usr/local/lib/python3.11/dist-packages (fr...
...
- stream[stdout] with 166 line(s); excerpt: Creating new Ultralytics Settings v0.0.6 file ✅ View Ultralytics Settings with 'yolo settings' or at '/root/.config/Ultralytics/settings.json' Update Settings with 'yolo settings k...
...
- stream[stdout] with 17 line(s); excerpt: all         50        600      0.999          1      0.995      0.995 I         50         50      0.999          1      0.995      0.995 II         50         50      0.998       ...
...
- stream[stdout] with 2 line(s); excerpt: 📂 جاري قراءة فهرس البيانات الحقيقية... ✅ تم تحميل 977 ملف إشارة حقيقي.
- stream[stderr] with 2 line(s); excerpt: /tmp/ipykernel_570/3213250916.py:30: UserWarning: Argument(s) 'quality_lower' are not valid for transform ImageCompression A.ImageCompression(quality_lower=50, p=0.3), # ضغط JPEG
...
- stream[stdout] with 1 line(s); excerpt: 🚀 بدء التدريب على بيانات Kaggle الحقيقية...
- stream[stderr] with 1 line(s); excerpt: Epoch 1/5: 100%|██████████| 55/55 [00:28<00:00,  1.92it/s, loss=0.813]
- stream[stdout] with 1 line(s); excerpt: Epoch 1 -> Train Loss: 0.8804 | Val Loss: 0.8091
- stream[stderr] with 1 line(s); excerpt: Epoch 2/5: 100%|██████████| 55/55 [00:25<00:00,  2.12it/s, loss=0.566]
- stream[stdout] with 1 line(s); excerpt: Epoch 2 -> Train Loss: 0.7319 | Val Loss: 0.6376
- stream[stderr] with 1 line(s); excerpt: Epoch 3/5: 100%|██████████| 55/55 [00:26<00:00,  2.11it/s, loss=0.302]
- stream[stdout] with 1 line(s); excerpt: Epoch 3 -> Train Loss: 0.4355 | Val Loss: 0.2890
- stream[stderr] with 1 line(s); excerpt: Epoch 4/5: 100%|██████████| 55/55 [00:26<00:00,  2.11it/s, loss=0.129]
- stream[stdout] with 1 line(s); excerpt: Epoch 4 -> Train Loss: 0.1940 | Val Loss: 0.1426
- stream[stderr] with 1 line(s); excerpt: Epoch 5/5: 100%|██████████| 55/55 [00:25<00:00,  2.13it/s, loss=0.0895]
- stream[stdout] with 2 line(s); excerpt: Epoch 5 -> Train Loss: 0.1122 | Val Loss: 0.0943 ✅ تم حفظ موديل U-Net المدرب على بيانات حقيقية!
