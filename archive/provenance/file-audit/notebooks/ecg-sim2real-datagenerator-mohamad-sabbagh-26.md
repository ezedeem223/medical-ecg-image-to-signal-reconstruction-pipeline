# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (26).ipynb`
...
| --- | --- |
| Review order | 27 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (26).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-26.md |
| SHA-256 | f0e9f1fe8ad89483ddb87097979e8a387308076733a5fe772b8de0626cebb30b |
| Size (bytes) | 40,092 |
| Modified (UTC) | 2026-04-18T19:43:36.990443+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (25).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (25).ipynb`, cell count changed from 5 to 5, stored output types changed from 10 to 10, and exact shared cell sources = 4.
- New imports: None
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني (Version 27: Strict Row Matching) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني النهائي (Version 26: Robust & Scoring Safe) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني (Version 27: Strict Row Matching) ---` |
...
- found_len = True
- grid_sizes = []
- leads_vals = processed_cache[raw_id_str_5000]
- lname = I[real_idx]
- pad = 5
- prev_cost = dp[idx]
...
- stream[stdout] with 4 line(s); excerpt: ⚡ حالة المسرع: cuda ⚙️ جاري تحميل المحرك البلاتيني... 🚀 بدء الاستخراج (Version 27: No Drops!)... 📊 عدد الصفوف المطلوب معالجتها: 24
- stream[stderr] with 1 line(s); excerpt: Inference: 100%|██████████| 24/24 [00:11<00:00,  2.15it/s]
- stream[stdout] with 1 line(s); excerpt: ✅ تم الانتهاء (Submission ready: Identical row count guaranteed).
