# File Audit: `ecg-sim2real-datagenerator-mohamad-sabbagh (28).ipynb`
...
| --- | --- |
| Review order | 29 |
| Original path | ecg-sim2real-datagenerator-mohamad-sabbagh (28).ipynb |
| Report path | docs/file-audit/notebooks/ecg-sim2real-datagenerator-mohamad-sabbagh-28.md |
| SHA-256 | 801d095ed9fa1a25600fb430ebc0fb9d752cdbf4a2e2fcee6355e5e1f710e8d9 |
| Size (bytes) | 39,876 |
| Modified (UTC) | 2026-04-18T20:11:43.502160+00:00 |
...
- Previous notebook: `ecg-sim2real-datagenerator-mohamad-sabbagh (27).ipynb`
- Compared with `ecg-sim2real-datagenerator-mohamad-sabbagh (27).ipynb`, cell count changed from 5 to 5, stored output types changed from 8 to 10, and exact shared cell sources = 3.
- New imports: `math`
- Removed imports: None
- New model refs: None
- Removed model refs: None
- New first-line titles: `# --- الخلية 22: المحرك البلاتيني (Version 29: Forced Integer IDs) ---`
- Removed first-line titles: `# --- الخلية 22: المحرك البلاتيني (Version 28: Universal Column Finder) ---`
...
| Cell type | code |
| Execution count | 4 |
| First non-empty line | `# --- الخلية 22: المحرك البلاتيني (Version 29: Forced Integer IDs) ---` |
...
- stream[stdout] with 4 line(s); excerpt: ⚡ حالة المسرع: cuda ⚙️ جاري تحميل الموديلات... 🚀 بدء الاستخراج (Version 29: Forced Integer IDs)... 📊 عدد الصفوف: 24
- stream[stderr] with 1 line(s); excerpt: Processing: 100%|██████████| 24/24 [00:32<00:00,  1.34s/it]
- stream[stdout] with 1 line(s); excerpt: ✅ تم الانتهاء (IDs Sanitized & Ready).
...
- stream[stdout] with 17 line(s); excerpt: 🔍 فحص العينة النهائية... First ID in file: 1053922973_0_I 📋 أول 5 صفوف: id   value 0  1053922973_0_I  0.0076 1  1053922973_1_I  0.0124 2  1053922973_2_I  0.0145 3  1053922973_3_I  ...
